...
- `fixtures/decks/animals/` is a tiny, deterministic workspace ("Animals"),
  shared by both clients:
    ...
    * `decks/fronts.md`, `decks/math.md`, `decks/multiple.md`,
      `decks/multiple-sequence.md`, `decks/source-fact.md`, `decks/source-stale.md`,
      `decks/trace-inline.md`, `decks/sectioned.md`,
