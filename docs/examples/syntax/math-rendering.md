...
<!-- id: card-25s0jpnhaw8qfv5k8yp0jha25d -->

## Inline math in an answer: what is the mass-energy relation?
$E = mc^2$
<!-- id: card-3hynx3kbyrt4chb2961hdac19s -->
...
<!-- id: card-06z5r3hv5k7nt2z57jwez747x3 -->

## What is the Gaussian integral?
$$\int_{-\infty}^{\infty} e^{-x^2}\,dx = \sqrt{\pi}$$
<!-- id: card-0ceyc641m6gzjweq7ftx9y7zts -->
...
<!-- id: card-3d0berjyra7j9bxswbt0p8cc4q -->

## State two trigonometric identities.
$\sin^2 x + \cos^2 x = 1$
$1 + \tan^2 x = \sec^2 x$
<!-- reveal: line -->
<!-- id: card-65vs1bsxy8mv71p285qhceazfs -->
...
<!-- id: card-2kk2avzmem577x00w3wrkmpbth -->

## Energy symbol
$E = mc^2$
<!-- direction: both -->
<!-- id: card-2bc9dv0cs3n0f5whc01eeqjrfk -->

## Type the derivative of $x^2$.
$2x$
<!-- id: card-77f0j9skjfa3wcd1aqtdb43sz1 -->
...
<!-- id: card-0dvtp8xgj0nca3jye0b3r61sjy -->
