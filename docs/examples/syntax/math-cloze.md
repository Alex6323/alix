...
> [!NOTE]
> One blank, one sub-card. The span must be a complete unit of the
> formula: a lone term like `4ac`, a base with its script like `b^2`,
> or a standalone symbol like `\pm`; a cut piece is a loud error.
