...
The flashcard **core** (reviewing, scheduling, every answer mode, browse, and the
web app) runs with nothing else installed: no accounts, no network. The **AI
features** (deck generation, the exam, traces, workspace generation, and the
...
[chapter 16](16-configuration.md#backends) for how to switch backends. You can use
the entire core without ever touching the AI layer.
